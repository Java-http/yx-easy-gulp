...
gulp.task('js',function(cb){
  var concatJS=['./src/script/lib/polyfill.min.js','./src/script/lib/jquery.min.js','./src/script/lib/vue.min.js','./src/script/lib/ele.js']
  // 公用js库
  var filterArray=concatJS.reduce(function(arr,item){
    var fullName="!**/*/"+path.basename(path.resolve(__dirname,item));
    arr.push(fullName)
    return arr;
  },['**'])
  gulp.src('./src/script/lib/*.js')
  .pipe(filter(filterArray))
